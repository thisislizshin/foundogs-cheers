...
contract MakersToken is ERC721Full {
    ...
    // dog 하나에 대한 토큰 정보
    // --------------------------------------------------
    function getDogs1 (uint256 tokenId) public view
    ...
    function getDogs2 (uint256 tokenId) public view
    ...
    function dogApply(uint256 tokenId, uint256 price, address FounDogs) public payable{  
        //dog 토큰에 지원자 추가하기
